...
namespace ADB_QLNHAKHOA.ViewModels
{
    public class AdminInfoViewModel: UserInfoViewModel
    {
        ...
        public ObservableCollection<AdminInfoViewModel> getStaffs()
        {
            try
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    while (reader.Read())
                    {   
                        AdminInfoViewModel vm = new AdminInfoViewModel();
        ...
        public AdminInfoViewModel getDetail(int id)
        {
            try
            {
        ...
        public ObservableCollection<AdminInfoViewModel> getStaffsByName(string str)
        {    
            try
            {
                Debug.WriteLine(str);
